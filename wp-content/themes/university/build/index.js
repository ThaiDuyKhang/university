      ...
      this.resultsDiv.html(`
        ...
        return `            
            ...
            <div class="one-third">
              ...
              ${results.programs.length ? '<ul class="link-list min-list">' : `<p>Không có chương trình học nào trong tìm tiếm. <a href="${universityData.root_url}/programs">Xem tất cả chương trình học</a></p>`}
        ...
        return `            
              ...
              ${results.professors.length ? '<ul class="professor-cards">' : `<p>Không có giảng viên nào trong tìm tiếm. <a href="${universityData.root_url}/professor">Xem tất cả giảng viên</a></p>`}
        ...
        return `            
            ...
            <div class="one-third">
              ...
              ${results.campuses.length ? '<ul class="link-list min-list">' : `<p>Không có cơ sở nào trong tìm tiếm. <a href="${universityData.root_url}/campuses">Xem tất cả cơ sở</a></p>`}
        ...
        return `            
              ...
              ${results.events.length ? '<ul class="link-list min-list">' : `<p>Không có sự kiện nào trong tìm tiếm. <a href="${universityData.root_url}/events">Xem tất cả sự kiện</a></p>`}
